...
{
    internal class KakaoAuthenticationHandler : AuthenticationHandler<KakaoAuthenticationOptions>
    {
        ...
        public KakaoAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new KakaoAuthenticatedContext(Context, user, accessToken, expires);
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new KakaoApplyRedirectContext(
                    Context, Options,
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new KakaoReturnEndpointContext(Context, ticket);

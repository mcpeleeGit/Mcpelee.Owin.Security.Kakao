...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the Kakao middleware
    /// </summary>
    public class KakaoApplyRedirectContext : BaseContext<KakaoAuthenticationOptions>
    {
        /// <summary>
        /// Creates a new context object.
        /// </summary>
        /// <param name="context">The OWIN request context</param>
        /// <param name="options">The Kakao middleware options</param>
        ...
        public KakaoApplyRedirectContext(IOwinContext context, KakaoAuthenticationOptions options,
